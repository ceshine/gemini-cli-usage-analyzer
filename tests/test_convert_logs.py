...
from gemini_cli_usage_analyzer.simplify_logs import SimplificationLevel
...
def test_convert_log_file_simplify(tmp_path):
    ...
    count, skipped = convert_log_file(input_file, output_file, simplify_level=SimplificationLevel.EVENTS_ONLY)
